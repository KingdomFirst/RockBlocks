...
// * Added the ability to display a search list of financial accounts rather than account picker for additional funds.
// </notice>
//
using System;
...
namespace RockWeb.Plugins.rocks_kfs.Finance
{
    ...
    [DisplayName( "Transaction Entry With Search" )]
    [Category( "KFS > Finance" )]
    [Description( "Creates a new financial transaction or scheduled transaction and allows searching for additional funds." )]
...
TransactionAccountDetails: [
  ...
  },
  {
    ...
    public partial class TransactionEntryWithSearch : Rock.Web.UI.RockBlock
    {
        #region Fields
        ...
        private void RegisterScript()
        {
            ...
            RockPage.AddScriptLink( ResolveUrl( "~/Plugins/rocks_kfs/Finance/Scripts/transaction-entry-search.js" ) );

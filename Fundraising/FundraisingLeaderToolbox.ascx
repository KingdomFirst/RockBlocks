<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FundraisingLeaderToolbox.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.Fundraising.FundraisingLeaderToolbox" %>
            ...
            <div class="margin-t-md">
                <Rock:Grid ID="gGroupMembers" runat="server" OnRowSelected="gGroupMembers_RowSelected" DataKeyNames="Id" PersonIdField="PersonId" AllowSorting="true">
                    <Columns>
                        ...
                        <Rock:CurrencyField DataField="TotalFunding" HeaderText="Total Funding" NullDisplayText="" />

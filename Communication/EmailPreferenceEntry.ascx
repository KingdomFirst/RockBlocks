<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmailPreferenceEntry.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.Communication.EmailPreferenceEntry" %>
...
<asp:UpdatePanel ID="upSettings" runat="server">
    <ContentTemplate>
        ...
        <div id="divNotInvolved" runat="server" style="display: none">
            ...
            <Rock:RockCheckBox ID="cbInactivateFamily" runat="server" Label="Inactivate All Family Members" Checked="false" />
        </div>

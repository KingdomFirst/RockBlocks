<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PersonAttributeFromAnotherEntity.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.Utility.PersonAttributeFromAnotherEntity" %>

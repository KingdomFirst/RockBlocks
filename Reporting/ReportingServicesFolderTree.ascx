<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportingServicesFolderTree.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.Reporting.ReportingServicesFolderTree" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlFolders" runat="server">
            <asp:Panel ID="pnlHeader" runat="server" CssClass="panel-heading">
                <h1 class="panel-title"><i class="fa fa-folder-open-o"></i>&nbsp;<asp:Literal ID="lTitle" runat="server" /></h1>
            </asp:Panel>

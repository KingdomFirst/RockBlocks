<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationEntry.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.Event.RegistrationEntry" %>
...
<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlHowMany" runat="server" Visible="false" CssClass="registrationentry-intro">
            ...
            <h1>How many
                <asp:Literal ID="lRegistrantTerm" runat="server" />
                will you be registering?</h1>
        ...
        <asp:Panel ID="pnlSummaryAndPayment" runat="server" Visible="false" CssClass="registrationentry-summary">
            ...
            <asp:Panel ID="pnlRegistrarInfo" runat="server" CssClass="well">
                ...
                <h4>This
                    <asp:Literal ID="lRegistrationTerm" runat="server" />
                    Was Completed By</h4>
                <div class="row">
                    <div class="col-md-6">

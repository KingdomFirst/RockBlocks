<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SharePage.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.Utility.SharePage" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-heading">
                <h1 class="panel-title"><i class="fa fa-share-square mr-2"></i>Share Page</h1>
            </div>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <Rock:PagePicker ID="ppExport" runat="server" Label="Page" Help="The page to be exported." Required="true" ValidationGroup="export" />
                    ...
                    <div class="col-md-6">
                        ...
                        <Rock:PagePicker ID="ppImportParentPage" runat="server" Label="Parent Page" Required="false" ValidationGroup="import" />

        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-heading">
                ...
                <div class="panel-labels">
                    ...
                    <asp:LinkButton ID="btnViewHistory" runat="server" CssClass="btn btn-default btn-xs" OnClick="btnViewHistory_Click" Visible="false" CausesValidation="false">View History</asp:LinkButton>
            ...
            <div class="panel-body">
                ...
                <div class="pull-right">
                    <asp:LinkButton ID="btnViewHistoryFtr" runat="server" CssClass="btn btn-default btn-sm" OnClick="btnViewHistory_Click" Visible="false" CausesValidation="false">View History</asp:LinkButton>

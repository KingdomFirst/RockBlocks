<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BatchToJournal.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.FinancialEdge.BatchToJournal" %>
...
<iframe id="feDownload" src="/Plugins/rocks_kfs/FinancialEdge/FinancialEdgeCsvExport.aspx" frameborder="0" width="0" height="0"></iframe>

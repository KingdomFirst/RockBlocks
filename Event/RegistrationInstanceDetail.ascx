    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlDetails" runat="server">
            ...
            <asp:Panel ID="pnlTabs" runat="server" Visible="false">
                ...
                <%--<asp:Panel ID="pnlVolunteers" runat="server" Visible="false" CssClass="panel panel-block">
                    <div class="panel-heading">
                        <h1 class="panel-title"><i class="fa fa-users"></i>Volunteers</h1>
                    </div>
                    <div class="panel-body">
                        <Rock:ModalAlert ID="mdVolunteerWarning" runat="server" />
                        <div class="grid grid-panel">
                            <Rock:GridFilter ID="fVolunteers" runat="server" OnDisplayFilterValue="fVolunteers_DisplayFilterValue" OnClearFilterClick="fVolunteers_ClearFilterClick">
                                <Rock:SlidingDateRangePicker ID="SlidingDateRangePicker1" runat="server" Label="Registration Date Range" />
                                <Rock:RockTextBox ID="RockTextBox1" runat="server" Label="First Name" />
                                <Rock:RockTextBox ID="RockTextBox2" runat="server" Label="Last Name" />
                                <Rock:RockDropDownList ID="RockDropDownList1" runat="server" Label="In Group" />
                                <Rock:RockDropDownList ID="RockDropDownList2" runat="server" Label="Signed Document" />
                                <asp:PlaceHolder ID="PlaceHolder1" runat="server" />
                            </Rock:GridFilter>
                            <Rock:Grid ID="gVolunteers" runat="server" DisplayType="Full" AllowSorting="true" RowItemText="Volunteer" PersonIdField="PersonId" ExportSource="ColumnOutput">
                                <Columns>
                                    <Rock:SelectField ItemStyle-Width="48px" />
                                    <Rock:RockTemplateField HeaderText="Volunteer" SortExpression="PersonAlias.Person.LastName, PersonAlias.Person.NickName" ExcelExportBehavior="NeverInclude">
                                        <ItemTemplate>
                                            <asp:Literal ID="lVolunteer" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </Rock:RockTemplateField>
                                    <Rock:RockBoundField HeaderText="First Name" DataField="Person.NickName" ExcelExportBehavior="AlwaysInclude" Visible="false" />
                                    <Rock:RockBoundField HeaderText="Last Name" DataField="Person.LastName" ExcelExportBehavior="AlwaysInclude" Visible="false" />

...
<asp:UpdatePanel ID="upRSConfig" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Panel ID="pnlRSConfig" runat="server" CssClass="panel panel-block" Visible="true">
            ...
            <div class="panel-body">
                <fieldset>
                    ...
                    <Rock:UrlLinkBox ID="tbReportingServicesURL" runat="server" Label="Report Server URL" Required="true" RequiredErrorMessage="Reporting Server URL required" ToolTip="URL to the Reporting Services Report Server endpoint." />
                    <Rock:RockTextBox ID="tbReportRootFolder" runat="server" Label="Root Folder Path" Required="true" RequiredErrorMessage="Root Folder is required" ToolTip="Root Folder for Reporting Services Reports." />
                    <h4>Credentials</h4>

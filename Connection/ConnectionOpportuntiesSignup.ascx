<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ConnectionOpportuntiesSignup.ascx.cs" Inherits="RockWeb.Plugins.com_kfs.Connection.ConnectionOpportuntiesSignup" %>

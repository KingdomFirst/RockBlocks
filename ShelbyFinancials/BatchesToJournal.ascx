<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BatchesToJournal.ascx.cs" Inherits="RockWeb.Plugins.com_kfs.ShelbyFinancials.BatchesToJournal" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlBatchList" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4 margin-t-md">
...
<iframe id="feDownload" src="/Plugins/com_kfs/ShelbyFinancials/ShelbyFinancialsExcelExport.aspx" frameborder="0" width="0" height="0"></iframe>
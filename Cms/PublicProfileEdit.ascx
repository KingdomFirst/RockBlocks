<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PublicProfileEdit.ascx.cs" Inherits="RockWeb.Plugins.com_kfs.Cms.PublicProfileEdit" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                ...
                                <div <% if ( ddlGradePicker.Visible ) { %> class="col-md-6" <% } else { %> class="col-md-12" <% } %> >

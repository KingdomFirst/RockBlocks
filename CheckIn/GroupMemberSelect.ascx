<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupMemberSelect.ascx.cs" Inherits="RockWeb.Blocks.CheckIn.PersonSelect" %>
...
<ContentTemplate>
    ...
    <div class="checkin-header">
        <h1><asp:Literal ID="lHeader" runat="server"></asp:Literal></h1>
    </div>

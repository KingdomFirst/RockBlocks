<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportingServicesPDFViewer.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.Reporting.SQLReportingServices.ReportingServicesPDFViewer" %>
<style>
    .fill {
    ...
    <ContentTemplate>
        <div class="panel panel-block">
            <div class="panel-heading">
                <h1 class="panel-title"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp;<asp:Literal ID="lReportTitle" runat="server" /></h1>
            </div>

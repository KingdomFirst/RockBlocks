<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransactionEntryWithSearch.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.Finance.TransactionEntryWithSearch" %>

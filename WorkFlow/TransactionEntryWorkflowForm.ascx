<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransactionEntryWorkflowForm.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.WorkFlow.TransactionEntryWorkflowForm" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlSuccess" runat="server" Visible="false">
            ...
            <asp:Panel ID="pnlSaveAccount" runat="server" Visible="false">
                ...
                <asp:HiddenField ID="hfWorkflowPerson" runat="server" />
            </asp:Panel>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationTemplateDetail.ascx.cs" Inherits="RockWeb.Plugins.com_kingdomfirstsolutions.Core.KFSRegistrationTemplateDetail" %>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupDetail.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.Event.GroupDetail" %>
                ...
                <div class="panel-body">
                    ...
                    <div id="pnlEditDetails" runat="server">
                        ...
                        <Rock:PanelWidget ID="wpGroupAttributes" runat="server" Title="Group Attribute Values">
                            <asp:PlaceHolder ID="phGroupAttributes" runat="server"></asp:PlaceHolder>
                        </Rock:PanelWidget>

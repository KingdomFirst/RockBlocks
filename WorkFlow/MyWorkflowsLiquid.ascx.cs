...
namespace RockWeb.Blocks.WorkFlow
{
    ...
    /// </summary>
    [DisplayName( "My Workflows Liquid - KFS" )]
    [Category( "KFS > WorkFlow" )]
    [Description( "Block to display workflow activities assigned to the current user that have a form entry action.  The display format is controlled by a liquid template." )]
...
{% endif %}
", "", 3 )]
    [BooleanField( "Include Inactive Workflows", "Should completed workflows be included?", true, "", 4 )]
    public partial class MyWorkflowsLiquid : Rock.Web.UI.RockBlock
    {
        ...
        {
            bool includeInactiveWorkflows = GetAttributeValue( "IncludeInactiveWorkflows" ).AsBoolean();

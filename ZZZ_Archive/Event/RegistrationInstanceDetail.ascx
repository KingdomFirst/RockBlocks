<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationInstanceDetail.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.Event.KFSRegistrationInstanceDetail" %>
<%@ Register TagPrefix="KFS" Namespace="rocks.kfs.EventRegistration.Advanced" Assembly="rocks.kfs.EventRegistration.Advanced" %>
<%@ Register TagPrefix="KFS" TagName="GroupPanel" Src="~/Plugins/rocks_kfs/Event/GroupPanel.ascx" %>
            ...
            <div class="panel panel-block">
                ...
                <div class="panel-heading panel-follow clearfix">
                    ...
                    <div class="panel-labels">
                        <asp:LinkButton ID="lbAdditionalLink" runat="server" CssClass="btn btn-link" Visible="false" OnClick="lbAdditionalLink_Click" />
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class='col-xs-4 text-right'>
                                                <asp:Literal ID="lTotalTotalCost" runat="server" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-8">Discount Qualified Cost</div>
                                            <div class='col-xs-4 text-right'>
                                                <asp:Literal ID="lTotalDiscountQualifiedCost" runat="server" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-8">Total Discount</div>
                                            <div class='col-xs-4 text-right'>
                                                <asp:Literal ID="lTotalDiscounts" runat="server" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-8">Registration Cost</div>
                                            <div class='col-xs-4 text-right'>
                                                <asp:Literal ID="lTotalRegistrationCost" runat="server" />
                                            </div>
                                        </div>
                                        <br />
                                        <div class="row">
                                            ...
                                            <div class='col-xs-4 text-right'>
                                                <asp:Literal ID="lTotalRegistrations" runat="server" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-8">Total Registrants</div>
                                            <div class='col-xs-4 text-right'>
                                                <asp:Literal ID="lTotalRegistrants" runat="server" />
                                            </div>
                                        </div>
                                    </div>
                                </asp:Panel>

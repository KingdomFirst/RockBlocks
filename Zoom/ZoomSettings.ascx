    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlWrapper" runat="server" CssClass="panel panel-block">
            <div class="panel-heading">
                <h1 class="panel-title"><i class="fa fa-video-alt"></i>Zoom Settings</h1>
                ...
                <asp:Panel ID="pnlApiSettings" runat="server" Visible="false">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <Rock:RockTextBox ID="tbApiKey" runat="server" Label="API Key" Required="true" RequiredErrorMessage="A Zoom API Key is Required" Help="The Zoom integration requires an API Key from a JWT developer application registered in the Zoom Marketplace. See this site for information on creating a Zoom JWT app: https://marketplace.zoom.us/docs/guides/build/jwt-app" />
                                    <Rock:RockTextBox ID="tbApiSecret" runat="server" Label="API Secret" Required="true" RequiredErrorMessage="A Zoom API Secret is Required" Help="The Zoom integration requires an API Secret from a JWT developer application registered in the Zoom Marketplace. See this site for information on creating a Zoom JWT app: https://marketplace.zoom.us/docs/guides/build/jwt-app" />
                                    <div class="actions">

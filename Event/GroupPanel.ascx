<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupPanel.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.Event.GroupPanel" %>
    ...
    <ContentTemplate>
        <Rock:PanelWidget ID="pnlSubGroup" runat="server">
            ...
            <div class="panel-labels">
                <asp:HyperLink ID="hlSyncSource" runat="server">

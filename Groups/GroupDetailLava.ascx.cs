...
namespace RockWeb.Blocks.Groups
{
    ...
    [BooleanField( "Enable Group Capacity Edit", "Enables changing Group Capacity when editing a group. Note: The group type must have a 'Group Capacity Rule'.", false, "", 13 )]
    [BooleanField( "Enable Parent Support", "Enables a Parent Roster tab and Email Parent button for any groups containing children.", false, "", 14 )]
                ...
                if ( eventArgs.Length == 2 )
                {
                    ...
                    switch ( action )
                    {
                        ...
                        case "SendAlternateCommunication":
                            SendAlternateCommunication( parameters );
                            break;
                    }
                }
            }

...
{
    /// <summary>
    /// Block to display dynamic report, html, xml, or transformed xml based on lava output as JSON.
    /// </summary>
    [DisplayName( "Dynamic Data Lava" )]
        ...
        private void BuildControls( bool setData )
        {
            ...
            else
            {
                ...
                if ( dataSetSchema != null )
                {
                    ...
                    {
                        string quickReturnLava = "{{ Title | AddQuickReturn:'Dynamic Data Lava', 80 }}";
